...
#define STRING_CONFIG_H_AUTHOR "(YannCymDev, Prusa I3)" // Who made the changes.
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 4 // If the temperature difference between the target temperature and the actual temperature
  ...
  // Ultimaker
  #define  DEFAULT_Kp 72
  #define  DEFAULT_Ki 9.1
